...
category_ids = Category.pluck(:id)  # pluck zwraca tablice ze wszystkimi wierszami z danej kolumny
...
50.times do
  product = Product.create! name: "#{Faker::Hacker.verb} #{Faker::Hacker.noun}".capitalize,
    ...
    product.remote_photo_url = Faker::Avatar.image(slug: product.name.parameterize,
                                                   size: "640x480",
                                                   format: "jpg",
